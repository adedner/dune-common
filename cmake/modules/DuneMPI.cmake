...
if(MPI_C_FOUND)
  ...
  dune_register_package_flags(COMPILE_DEFINITIONS "HAVE_MPI;MPICH_SKIP_MPICXX;OMPI_SKIP_MPICXX;MPIPP_H;MPI_NO_CPPBIND"
...
function(add_dune_mpi_flags)
  ...
  if(MPI_C_FOUND)
    ...
    set_property(${_prefix} ${ADD_MPI_UNPARSED_ARGUMENTS} APPEND PROPERTY COMPILE_DEFINITIONS HAVE_MPI
