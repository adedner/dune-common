...
#
#    :code:`GRIDTYPE` can be anything defined in :code:`config.h` via the
#    :ref:`dune_define_gridtype` macro from dune-grid.
#    Furthermore any CPP variable of the form :code:`-DVAR=VALUE` can be overloaded on the command
#    line.
#
#    .. note::
...
macro(find_extended_unix_commands)
  message(DEPRECATION "find_extended_unix_commands is deprecated. Use "
    "'dune_find_extended_unix_commands' instead.")
...
macro(initialize_compiler_script)
  message(DEPRECATION "initialize_compiler_script is deprecated. Use "
    "'dune_initialize_compiler_script' instead.")
...
macro(finalize_compiler_script)
  message(DEPRECATION "finalize_compiler_script is deprecated. Use "
    "'dune_finalize_compiler_script' instead.")
