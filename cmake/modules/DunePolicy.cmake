...
function(dune_get_policy _policy _var)
  if(DEFINED DUNE_POLICY_${_policy})
    set(_policy_defined TRUE)
  else()
  ...
  if(DUNE_POLICY_${_policy})
    set(_policy_set TRUE)
    set(_policy_value ${DUNE_POLICY_${_policy}})
  else()
...
function(dune_set_policy _policy _value)
  if(DEFINED DUNE_POLICY_${_policy})
    unset(DUNE_POLICY_${_policy} PARENT_SCOPE)
  endif()
  if(DEFINED CACHE{DUNE_POLICY_${_policy}})
    unset(DUNE_POLICY_${_policy} CACHE)
  endif()
  get_property(_policy_defined GLOBAL PROPERTY DUNE_POLICY_${_policy} DEFINED)
  if(NOT _policy_defined)
    if(DUNE_POLICY_IGNORE_UNDEFINED)
