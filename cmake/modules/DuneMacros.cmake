...
macro(dune_target_get_cxx_standard target var)
  ...
  if(NOT ${var})
    ...
    get_target_property(_features2 ${target} ${_interface}COMPILE_FEATURES)
  ...
  if(NOT ${var})
    ...
    get_target_property(_options2 ${target} ${_interface}COMPILE_OPTIONS)
